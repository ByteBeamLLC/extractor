  ...
  return (
    <>
      ...
      <AdsLandingPage
        ...
        testimonials={[
          {
            quote: "We replaced 3 hours of daily invoice data entry with a fully automated pipeline. Parsli paid for itself in the first week.",
            name: "Sarah M.",
            role: "Operations Manager",
            company: "Logistics Company",
          },
          {
            quote: "Our team used to manually key in 200+ documents per week. Now the AI handles it in minutes — more accurate than we ever were.",
            name: "David R.",
            role: "AP Lead",
