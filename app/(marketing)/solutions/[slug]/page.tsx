...
> = {
  "pdf-to-excel": [
    ...
    { href: "/tools/pdf-to-text", label: "Free PDF to Text Extractor" },
  ...
  "no-code-document-parser": [
    { href: "/tools/invoice-parser", label: "Free Invoice Parser" },
    { href: "/tools/ai-summarizer", label: "Free AI Document Summarizer" },
    { href: "/tools/resume-parser", label: "Free Resume Parser" },
