...
const templateMap: Record<string, { templateId: string; ctaLabel: string }> = {
  ...
  "ai-invoice-processing": {
    templateId: "invoice-parsing",
    ctaLabel: "Start Processing Invoices Free",
  },
}
...
> = {
  "pdf-to-excel": [
    ...
    { href: "/tools/pdf-to-google-sheets", label: "Free PDF to Google Sheets" },
    { href: "/tools/pdf-to-json", label: "Free PDF to JSON Converter" },
    { href: "/tools/pdf-to-xml", label: "Free PDF to XML Converter" },
  ...
  "invoice-parsing": [
    ...
    { href: "/tools/receipt-scanner", label: "Free Receipt Scanner" },
    ...
    { href: "/solutions/ai-invoice-processing", label: "AI Invoice Processing" },
  ],
  "bank-statement-extraction": [
    { href: "/tools/bank-statement-parser", label: "Free Bank Statement Parser" },
    { href: "/tools/pdf-to-excel", label: "Free PDF to Excel Converter" },
  ...
  "no-code-document-parser": [
    ...
    { href: "/tools/scan-to-text", label: "Free Scan to Text" },
  ...
  "document-parser": [
    { href: "/tools/pdf-to-excel", label: "Free PDF to Excel Converter" },
    { href: "/tools/pdf-to-json", label: "Free PDF to JSON Converter" },
    { href: "/tools/pdf-to-text", label: "Free PDF to Text Converter" },
    { href: "/tools/ocr", label: "Free Online OCR" },
    { href: "/guides/extract-data-from-pdfs-without-code", label: "Extract Data Without Code" },
    { href: "/guides/what-is-document-parsing", label: "What Is Document Parsing?" },
    { href: "/compare/docparser", label: "Parsli vs Docparser" },
    { href: "/compare/parseur", label: "Parsli vs Parseur" },
    { href: "/compare/nanonets", label: "Parsli vs Nanonets" },
  ...
  "intelligent-document-processing": [
    { href: "/tools/ocr", label: "Free Online OCR" },
    { href: "/tools/invoice-parser", label: "Free Invoice Parser" },
    { href: "/guides/what-is-intelligent-document-processing", label: "What Is IDP?" },
    { href: "/use-cases/intelligent-document-processing", label: "IDP Use Case" },
    { href: "/compare/nanonets", label: "Parsli vs Nanonets" },
    { href: "/compare/abbyy", label: "Parsli vs ABBYY" },
    { href: "/compare/uipath", label: "Parsli vs UiPath" },
    { href: "/solutions/document-parser", label: "AI Document Parser" },
    { href: "/solutions/document-processing-software", label: "Document Processing Software" },
  ],
  "email-management": [
    { href: "/email-parser", label: "Email Parser" },
    { href: "/tools/image-to-text", label: "Free Image to Text" },
    { href: "/integrations/gmail", label: "Gmail Integration" },
    { href: "/integrations/outlook", label: "Outlook Integration" },
    { href: "/guides/parse-email-attachments-automatically", label: "Auto-Parse Email Attachments" },
    { href: "/guides/parse-email-attachments-with-zapier", label: "Parse Emails with Zapier" },
    { href: "/blog/best-email-parser-tools", label: "Best Email Parser Tools" },
    { href: "/compare/mailparser", label: "Parsli vs Mailparser" },
    { href: "/compare/parseur", label: "Parsli vs Parseur" },
    { href: "/compare/zapier-email-parser", label: "Parsli vs Zapier Email Parser" },
  ],
  ...
  "ai-invoice-processing": [
    ...
    { href: "/use-cases/invoice-parsing", label: "Invoice Parsing Use Case" },
    { href: "/guides/automate-invoice-processing-for-small-business", label: "Automate Invoice Processing" },
    { href: "/guides/extract-invoice-data-to-quickbooks", label: "Invoice Data to QuickBooks" },
    { href: "/blog/best-invoice-ocr-software", label: "Best Invoice OCR Software" },
    { href: "/compare/nanonets", label: "Parsli vs Nanonets" },
    { href: "/compare/docsumo", label: "Parsli vs Docsumo" },
    { href: "/compare/rossum", label: "Parsli vs Rossum" },
