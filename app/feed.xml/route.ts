...
export async function GET() {
  ...
  const toolPages = [
    ...
    { slug: "image-to-text", title: "Image to Text (OCR)", desc: "Extract text from images using OCR. Free, supports 12 languages. Keyword-rich SEO and HowTo structured data.", date: "2026-04-03" },
    ...
    { slug: "invoice-parser", title: "Invoice Parser", desc: "Extract data from invoices automatically. Free AI-powered invoice OCR tool with structured output.", date: "2026-04-03" },
