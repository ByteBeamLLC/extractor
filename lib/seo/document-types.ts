...
export const documentTypes: DocumentTypeData[] = [
  ...
  },
  {
    ...
    metaTitle: "Extract Data from Bills of Lading with AI | Parsli",
    metaDescription: "AI-powered BOL data extraction. Pull shipper, consignee, weight, freight class, PRO number, and all FMCSA fields from any bill of lading format. Start free.",
    h1: "Bill of Lading Data Extraction",
    heroDescription: "Extract structured data from any bill of lading format — PDF, scanned, faxed, or photographed thermal prints. Parsli's AI reads the document and returns clean, typed data for all [17 FMCSA-mandated fields](/blog/bill-of-lading-requirements-complete-guide). Try the [free BOL parser](/tools/bol-parser) for instant text extraction.",
    extractableFields: [
      { name: "Shipper Name & Address", description: "Full shipper company name, street address, city, state, and ZIP code." },
      { name: "Consignee Name & Address", description: "Receiver/consignee company name and full delivery address." },
      { name: "Description of Goods", description: "Detailed description of cargo being shipped, including material type and condition." },
      { name: "Weight & Piece Count", description: "Total shipment weight in pounds and number of pieces, pallets, or handling units." },
      { name: "Freight Class & NMFC Code", description: "National Motor Freight Classification code and freight class for rating purposes." },
      { name: "PRO Number", description: "Progressive/tracking number assigned by the carrier for shipment identification." },
      { name: "Special Instructions", description: "Delivery instructions, temperature requirements, hazmat flags, or handling notes." },
      { name: "Carrier & Signatures", description: "Carrier name, driver signature, pickup/delivery dates, and seal numbers." },
    ],
    supportedFormats: ["PDF BOLs", "Scanned BOLs", "Faxed BOLs", "Thermal prints (photos)", "Digital/eBOLs"],
    faqs: [
      { question: "Can Parsli extract data from faded thermal BOL prints?", answer: "Yes. Parsli uses Google Gemini 2.5 Pro which reads faded thermal prints, low-contrast warehouse scans, and carbon copies better than traditional OCR." },
      { question: "Does it handle different BOL formats from different carriers?", answer: "Yes. The AI adapts to any BOL layout — UPS, FedEx, XPO, ODFL, or custom carrier formats — without template configuration." },
      { question: "Can I extract data from handwritten BOLs?", answer: "Yes. The AI can process handwritten entries on BOLs, though accuracy depends on legibility. Combine with the [logistics solution](/solutions/logistics-document-automation) for end-to-end automation." },
    ],
    relatedUseCases: ["bill-of-lading-parsing", "pdf-data-extraction", "document-automation"],
    relatedIndustries: ["logistics"],
    relatedSolutions: ["logistics-document-automation", "document-parsing-api"],
  },
  {
    slug: "freight-invoices",
    name: "Freight Invoices",
    metaTitle: "Extract Data from Freight Invoices with AI | Parsli",
    metaDescription: "AI freight invoice data extraction. Pull carrier name, PRO number, rates, surcharges, and totals from any carrier's invoice format. Automate freight AP. Start free.",
    h1: "Freight Invoice Data Extraction",
    heroDescription: "Extract structured data from any carrier's freight invoice — PDF, scanned, or email attachment. Parsli's AI reads carrier-specific layouts and returns clean data for [automated freight invoice processing](/use-cases/freight-invoice-processing).",
    extractableFields: [
      { name: "Carrier Name", description: "Shipping carrier or freight company name from the invoice header." },
      { name: "PRO Number", description: "Progressive/tracking number linking the invoice to the original shipment." },
      { name: "Origin & Destination", description: "Pickup and delivery city, state, ZIP, and facility names." },
      { name: "Weight & Class", description: "Shipment weight and freight classification for rate verification." },
      { name: "Base Rate & Fuel Surcharge", description: "Base freight rate and fuel surcharge amounts for the shipment." },
      { name: "Accessorial Charges", description: "Additional service charges — liftgate, residential delivery, detention, inside delivery, etc." },
      { name: "Total Due", description: "Total invoice amount including all charges, surcharges, and adjustments." },
      { name: "BOL Reference", description: "Reference to the original bill of lading number for 3-way matching." },
    ],
    supportedFormats: ["PDF freight invoices", "Scanned carrier invoices", "Email attachment invoices", "EDI-converted PDFs"],
    faqs: [
      { question: "Can Parsli handle invoices from different carriers?", answer: "Yes. Parsli's AI adapts to any carrier invoice format — UPS, FedEx Freight, XPO, ODFL, Estes, R+L, Saia, and more. No carrier-specific templates needed." },
      { question: "Can I do 3-way matching with extracted data?", answer: "Yes. Extract data from freight invoices, [bills of lading](/document-types/bills-of-lading), and purchase orders, then match them in your accounting system to catch billing errors before payment." },
      { question: "Does it extract accessorial charges?", answer: "Yes. The AI identifies and extracts individual accessorial charges (liftgate, detention, fuel surcharge, etc.) as line items with amounts." },
    ],
    relatedUseCases: ["freight-invoice-processing", "invoice-parsing", "email-parsing"],
    relatedIndustries: ["logistics"],
