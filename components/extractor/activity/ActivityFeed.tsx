  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border rounded-lg overflow-hidden">
        <div className="grid grid-cols-[1fr_100px] sm:grid-cols-[1fr_100px_100px_80px_120px] gap-2 px-4 py-2 bg-muted/50 text-xs font-medium text-muted-foreground border-b">
          <span>Document</span>
          ...
          {documents.map((doc) => {
            ...
            return (
              <button
                ...
                className="w-full grid grid-cols-[1fr_100px] sm:grid-cols-[1fr_100px_100px_80px_120px] gap-2 px-4 py-3 text-left hover:bg-accent/30 transition-colors items-center"
              >
