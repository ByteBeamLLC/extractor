...
const tiers = [
  ...
  },
  {
    name: "Starter tier",
    key: "starter",
    description: "Our entry plan. Start automating your extractions.",
    cta: "Start free trial",
  },
  {
    name: "Growth tier",
    key: "growth",
    description: "For growing teams. Best value per page.",
    cta: "Start free trial",
    highlighted: true,
  },
  {
...
const rows: Row[] = [
  {
    ...
    values: ["Up to 30", "Up to 250", "Up to 1,000", "Up to 5,000", "Up to 25,000"],
  },
  {
  ...
  },
  {
    ...
    values: ["1 user", "1 user", "1 user", "Up to 10", "Unlimited"],
  },
  {
    feature: "Document retention",
    values: ["30 days", "90 days", "1 year", "Unlimited", "Unlimited"],
  },
  ...
  { feature: "Make.com", values: [true, true, true, true, true] },
  { feature: "Webhooks", values: [true, true, true, true, true] },
  { feature: "API", values: [true, true, true, true, true] },
  // Category: Support
  {
            ...
            <div className="rounded-xl border bg-card overflow-hidden">
              {rows.map((row, ri) => {
                ...
                return (
                  <div
                    key={row.feature}
                    className="grid grid-cols-6 gap-0 px-6 py-3 items-center border-t border-border/40"
                  >
