...
export function ExcelToJsonTool() {
  ...
  const processFile = useCallback(async (file: File) => {
    ...
    try {
      ...
      console.error("Excel to JSON conversion error:", e)
        ...
        >
          <div className="flex flex-col items-center justify-center py-14 px-6">
            ...
            <p className="text-sm text-muted-foreground">
              .xlsx or .xls files up to 50 MB. Converts to JSON instantly.
            </p>
          </div>
          <input
            ref={inputRef}
