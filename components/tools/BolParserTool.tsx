...
export function BolParserTool() {
  ...
  const handleDownload = useCallback(() => {
    ...
    a.href = url
    a.download = `${fileName?.replace(/\.[^.]+$/, "") || "bol"}-extracted.txt`
    a.click()
    ...
    <div className="w-full max-w-2xl mx-auto">
        ...
        >
          <div className="flex flex-col items-center justify-center py-14 px-6">
            ...
            <p className="text-lg font-semibold mb-1">
              Drop your bill of lading here or click to browse
            </p>
      ...
      {status === "processing" && (
        <div className="rounded-2xl border bg-card p-10 text-center">
          ...
          <p className="font-semibold text-lg mb-1">Extracting text from your bill of lading...</p>
          ...
          <div className="px-6 py-4 border-t">
            <div className="rounded-xl border-2 border-primary/20 bg-primary/5 p-5 text-center">
              ...
              <p className="font-semibold mb-1">
                Want structured BOL data instead of raw text?
              </p>
              <p className="text-sm text-muted-foreground mb-3">
                Parsli AI extracts shipper, consignee, weight, freight class,
                PRO number, and more as structured JSON with custom schemas.
              </p>
      ...
      {status === "error" && (
        <div className="rounded-2xl border bg-card overflow-hidden">
          ...
          {fileTooLarge ? (
            <FileSizeBridgeBanner toolName="bol_parser" />
          ) : (
            <div className="px-6 py-4 border-t flex flex-col sm:flex-row gap-3">
              ...
              <Button asChild className="h-10">
                <a href="/solutions/logistics-document-automation">
