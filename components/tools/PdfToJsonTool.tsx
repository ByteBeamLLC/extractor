...
export function PdfToJsonTool() {
  ...
  const processFile = useCallback(async (file: File) => {
    ...
    try {
      ...
      // Split text by form-feed characters (page breaks) if present, else treat as single page
      ...
      console.error("PDF to JSON conversion error:", e)
      setError(
    ...
    <div className="w-full max-w-2xl mx-auto">
        ...
        >
          <div className="flex flex-col items-center justify-center py-14 px-6">
            ...
            <p className="text-sm text-muted-foreground">
              PDF files up to 50 MB. Converts to structured JSON instantly.
            </p>
          </div>
          <input
            ref={inputRef}
      ...
      {status === "processing" && (
        <div className="rounded-2xl border bg-card p-10 text-center">
          ...
          <p className="font-semibold text-lg mb-1">Converting to JSON...</p>
        ...
        <div className="rounded-2xl border bg-card overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b bg-green-50 dark:bg-green-950/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-sm">JSON generated</p>
      ...
      {status === "error" && (
        <div className="rounded-2xl border bg-card overflow-hidden">
          ...
          {fileTooLarge ? (
            <FileSizeBridgeBanner toolName="pdf_to_json" />
          ) : (
            <div className="px-6 py-4 border-t flex flex-col sm:flex-row gap-3">
