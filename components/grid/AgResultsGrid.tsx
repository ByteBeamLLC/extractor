...
const moduleRegistration = globalThis as {
  __AG_GRID_ALL_COMMUNITY_REGISTERED__?: boolean
}

if (!moduleRegistration.__AG_GRID_ALL_COMMUNITY_REGISTERED__) {
  ModuleRegistry.registerModules([AllCommunityModule])
  moduleRegistration.__AG_GRID_ALL_COMMUNITY_REGISTERED__ = true
}
