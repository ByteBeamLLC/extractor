...
export function TanStackGridSheet({
  ...
  // #endregion
  // Memoize table method calls to prevent repeated invocations.
  // NOTE: Must include rowData/columnDefs in deps because table instance reference
  // stays stable even when data changes - TanStack Table updates internally.
